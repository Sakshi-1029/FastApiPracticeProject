...
class GenerateSchema:
    ...
    def generate_schema(
        ...
        return self._generate_schema_for_type(
            obj,
            from_dunder_get_core_schema=from_dunder_get_core_schema,
            from_prepare_args=from_prepare_args,
        )
    ...
    def _computed_field_schema(
        self, d: Decorator[ComputedFieldInfo]
    ...
    def _apply_annotations(  # noqa: C901
        ...
        non_field_infos, field_infos = [
            a for a in annotations if not isinstance(a, FieldInfo)
